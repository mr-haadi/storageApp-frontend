...
import { getExt, getFileEmoji, formatSize, formatDate } from "../utils/directoryUtils";
  ...
  return (
    <Modal title="Details" onClose={onClose}>
      <div style={{
        ...
        padding: "12px 0 20px", borderBottom: "1px solid var(--border)", marginBottom: 16,
      }}>
        ...
        <div style={{ minWidth: 0 }}>
          ...
          <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 3 }}>
            {item.isDirectory ? "Folder" : ext.toUpperCase() + " · " + formatSize(item.size)}
          </div>
        </div>
      </div>
